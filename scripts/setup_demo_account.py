#!/usr/bin/env python3
"""
Demo Data Script for Noel12345 Account
Populates the account with rich, interconnected notes to showcase all features
"""
...
# Database setup
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./data/database/secondbrain.db")
engine = create_engine(DATABASE_URL, connect_args={"check_same_thread": False} if "sqlite" in DATABASE_URL else {})
SessionLocal = sessionmaker(autocommit=False, autoflush=False, bind=engine)

# Rich demo notes showcasing different features
DEMO_NOTES = [
    {
        "title": "Welcome to Your Second Brain! 🧠",
        "content": """# Welcome to Octopus SecondBrain!
...
#python #programming #best-practices #coding""",
    ...
    },
    {
        ...
        "content": """# Data Science Project Workflow
...
#data-science #workflow #analytics #machine-learning""",
        "tags": ["data-science", "workflow", "analytics", "machine-learning"]
    },
    {
...
#knowledge-graphs #semantic-networks #AI #graph-theory""",
        "tags": ["knowledge-graphs", "semantic-networks", "AI", "graph-theory"]
    },
    {
...
#embeddings #vectors #semantic-search #AI #NLP""",
        "tags": ["embeddings", "vectors", "semantic-search", "AI", "NLP"]
    },
    {
        "title": "Productivity Systems and Note-Taking",
        "content": """# Effective Note-Taking Systems
...
#productivity #note-taking #zettelkasten #knowledge-management #PKM""",
        "tags": ["productivity", "note-taking", "zettelkasten", "knowledge-management", "PKM"]
    },
    {
        "title": "Graph Databases vs Relational Databases",
        "content": """# Graph vs Relational Databases
...
#databases #graph-databases #SQL #data-modeling #architecture""",
        "tags": ["databases", "graph-databases", "SQL", "data-modeling", "architecture"]
    },
    {
        "title": "Project Ideas: AI & Data Science",
        "content": """# Cool AI Project Ideas
...
#projects #AI #machine-learning #data-science #ideas""",
        "tags": ["projects", "AI", "machine-learning", "data-science", "ideas"]
    },
    {
        "title": "Learning Resources for AI/ML",
        "content": """# Best Resources for Learning AI & ML
...
#learning #resources #AI #machine-learning #education""",
        "tags": ["learning", "resources", "AI", "machine-learning", "education"]
    },
    {
        "title": "Web Development Stack 2025",
...
#web-development #programming #full-stack #technology""",
        "tags": ["web-development", "programming", "full-stack", "technology"]
    },
    {
        "title": "Time Management Techniques",
        "content": """# Effective Time Management
...
#productivity #time-management #getting-things-done #focus""",
        "tags": ["productivity", "time-management", "getting-things-done", "focus"]
    },
    {
...
#API #REST #web-development #backend #architecture""",
        "tags": ["API", "REST", "web-development", "backend", "architecture"]
    }
]


async def create_demo_data():
    """Create demo data for Noel12345 account"""
    db = SessionLocal()
    
    try:
        # Check if user exists
        user = db.query(User).filter(User.username == "Noel12345").first()
        
        if not user:
            print("❌ User 'Noel12345' not found. Please create the account first:")
            print("   Username: Noel12345")
            print("   Password: Noel12345")
            print("   Email: noel@example.com")
            return
        ...
        if existing_notes:
            print(f"🗑️  Deleting {len(existing_notes)} existing notes...")
            for note in existing_notes:
                db.delete(note)
            db.commit()
        
        # Create demo notes
        print(f"\n📝 Creating {len(DEMO_NOTES)} demo notes...")
        
        for i, note_data in enumerate(DEMO_NOTES, 1):
            # Create note with timestamp variation
            created_at = datetime.utcnow() - timedelta(days=len(DEMO_NOTES) - i)
        ...
        db.commit()
        print("\n✅ All demo notes created successfully!")
        
        # Generate embeddings
        print("\n🧠 Generating embeddings for semantic search...")
        all_notes = db.query(Note).filter(Note.user_id == user.id).all()
        
        for note in all_notes:
            try:
                embedding = await get_embeddings(note.content[:1000])  # First 1000 chars
                # Store embedding in note (if you have an embedding field)
        ...
        print("="*60)
        print("\n📊 Features to explore:")
        print("   1. View all notes on the Notes page")
        print("   2. Try semantic search with terms like 'neural networks' or 'productivity'")
        print("   3. Explore the Neural Map in 3D to see connections")
        print("   4. Filter by tags like #AI, #programming, #productivity")
        print("   5. Test different layout modes (Force, Tree, Radial)")
        print("   6. Try bulk import feature to add more notes")
        print("\n💡 The notes are interconnected - explore the relationships!")
...
if __name__ == "__main__":
    print("=" * 60)
    print("🐙 Octopus SecondBrain - Demo Data Generator")
    print("=" * 60)
